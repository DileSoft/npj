...
WordCleaner.prototype.makeCleanHTML = function(s) {
 ...
 s = this.cleanUpAttributesAll(s, "table|thead|tbody|tr|td", "colspan|rowspan|align|class|valign|cellpadding|cellspacing");
 s = this.cleanUpAttributesAll(s, "ul|ol", "class|type|start|value");
