...
$rh->UseClass("WackoFormatter", $rh->formatters_classes_dir);

$text = str_replace("\r", "", $text);
$text = "\177\n".$text."\n";

$text .= "@@"; // приписываем в конец закрывашку ката.

$parser = &new WackoFormatter( &$object );
...
// убираем закрывашку ката, если она такая осталась
$text = rtrim($text, "@@");
