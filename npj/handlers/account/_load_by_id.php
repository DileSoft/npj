...
*/
  ...
  $fields[] = $fields[0].", account_type, account_class, populate_type, domain_type, node_id, owner_user_id, alive, password, login_cookie, root_record_id, original_user_id";
  ...
  if ($rs->fields)
  //if ($rh->principal->data["user_id"] != $result["user_id"]) // 20.06.2005 removed by kuso to conform with new UI simplification guides
  {
